...
Future<AccountDevices> getList(http.Client client, String authToken,
    String nextPageToken, Map<Filters, String> filters) async {
  ApiCalls apiCall = ApiCalls(client);
  return await apiCall.getDeviceList(authToken, nextPageToken, filters);
}
